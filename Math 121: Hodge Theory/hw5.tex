...
\begin{problem}{3}(The Hodge Decomposition for Curves)
    ...
    \begin{enumerate}
        ...
        \[ 0 \to \C \to \OO_X \rightarrow \to \Omega_X \to 0\]
        ...
        \[ 0 \to H^0(X, \Omega_X) \to H^1(X, \C) \to H^1(X, \OO_X) \to 0\]
        \item[(d)] Show that the map which to a holomorphic form $\alpha$ associates the class of $\overline{\alpha}$ in $H^1(X, \OO_X)$ is injective.
        ...
        with 
        \[ \overline{H^0(X, \Omega_X)} \cong H^1(X, \OO_X)\]
    \end{enumerate}
...
\begin{solution}
    \bbni 
    \begin{enumerate}
        \item Let $U$ be an open set of $X$. Let $\omega \in \Omega_X(U)$ be a section. Then $\omega = f dz$ in local coordinates. Since holomorphic functions are analytic, they have a primitive locally. Thus, there exists $g \in \OO_X(U)$ such that $dg/dz = f$. Then, we have that $d(g) = f dz = \omega$. Thus, $d$ is surjective. \bbni
        Now let $f \in \OO_X(U)$ such that $df = 0$. Thus, $f$ is locally constant. Since $X$ is compact and connected, $f$ extends to a globally constant function in $\OO_X(X)$. Thus, $\ker(d) = \C$, the constant sheaf. \bbni
        Thus, we have the exact sequence:
        \[ 0 \to \C \to \OO_X \xrightarrow{d} \Omega_X \to 0\]
        \item Recall that Serre duality gives us the isomorphism:
        \[ H^1(X, \Omega_X) \cong H^0(X, \Omega_X^\vee \otimes \Omega_X)^\vee\]
        However, $\Omega_X^\vee \otimes \Omega_X \cong \OO_X$ (by contracting). Thus, we have:
        \[ H^1(X, \Omega_X) \cong H^0(X, \OO_X)^\vee\]
        However, $H^0(X, \OO_X) \cong \C$ as global holomorphic functions on a compact connected surface are constant. Thus, $H^1(X, \Omega_X) \cong H^0(X, \OO_X)^\vee \cong \C$. \bbni
        ...
        \begin{align*}
            \to H^0(X, \C) \to H^0(X, \OO_X) \xrightarrow{d} H^0(X, \Omega_X) \to H^1(X, \C) \to \cdots
        \end{align*}
        Note that $H^0(X, \C)$ are the globally constant functions, which are the same as the global holomorphic functions on a compact connected manifold. Thus, the first map is an isomorphism. Thus, $d:H^0(X, \OO_X) \to H^0(X, \Omega_X)$ is $0$. Thus, the sequence becomes:
        \[0 \to H^0(X, \Omega_X) \to H^1(X, \C) \to H^1(X,\OO_X) \to H^1(X, \Omega_X) \to H^2(X, \C) \to  H^2(X, \OO_X) \]
        Then, since $H^2(X, \OO_X) = H^{0,2}(X) = 0$, the last map is $0$. Thus, the map $H^1(X, \Omega_X) \to H^2(X, \C)$ is an isomorphism. Thus, the map before it is $0$, and we get:
        \[0 \to H^0(X, \Omega_X) \to H^1(X, \C) \to H^1(X,\OO_X) \to 0  \]   
        \item Let $\alpha \in H^0(X, \Omega_X)$ be a global holomorphic form. Then, $\overline{\alpha} \in H^1(X, \C)$ is of type $(0, 1)$ (antiholomorphic). If $[\overline{\alpha}] = 0 \in H^1(X, \OO_X)$, then $\overline{\alpha}$ is in $\img(H^0(X, \Omega_X) \to H^1(X, \C))$. But this is an inclusion map (the connecting morphism deals solely with holomorphic objects), thus, we would have $\overline{\alpha} = \beta$ for some global holomorphic form $\beta$. This implies $\alpha = 0$. Thus, the map is injective. 
        ...
        \[ \dim(H^1(X, \Omega_X)) = \dim(H^0(X, \OO_X))\]
