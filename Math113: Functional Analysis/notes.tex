...
\begin{itemize}
    ...
    \[\EE = \overline{\opspan\{e_n : n \in \N\}}\] 
    Then, for all $h \in H$, 
    \[ \sum_{n=1}^\infty (h\mid e_n)e_n\]
    converges in $H$ and: 
    \[ P_\EE (h) = \sum_{n=1}^\infty (h\mid e_n)e_n\]
    Proof. Pictures. 
    ...
    (1) $\implies$ (3). Apply the $P_\EE$ corollary with $\EE = H$. \\
    ...
    \end{align*}
    Thus, $\norm{T-T_n} \leq \sup_{k \geq n} |\lambda_k|^2$. Thus, $T_n \to T$ in the operator norm. Thus, $T \in \mathcal{K}(H)$ since $(T_n) \subset \mathcal{L}_{\FF}(H)$.
